      ...
      <div class="container-fluid">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">Statistiques et informations utiles</h1>
          </div>
			<form action="admin-bilan.html">
			  <div class="form-row">
				<div class="col-md-4 mb-3">
				  <label for="validationDefault01">Identifiant du client</label>
				  <input type="text" class="form-control" id="validationDefault01" placeholder="id_client" required>
				</div>
			  </div>
			  <div class="form-row">
			  </div>
